"""rpg/ui/help_dialog.py -- in-game help dialog (DOC-03).

Renders the curated help content from ``rpg/data/help.json``: the editing
...
class HelpDialog(QtWidgets.QDialog):
    """In-game help dialog rendering ``rpg/data/help.json``.
    ...
    def __init__(self, parent=None):
        ...
        # via rpg.paths.data_path -- __file__-relative, Pitfall 1 mitigation).
        help_path = str(rpg.paths.data_path("data", "help.json"))
