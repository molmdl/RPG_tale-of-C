# rpg/ui/controller.py -- Phase 6 Plan 06-06 the Qt-free Controller (mediator)
...
# the injected view.
#
# Qt-FREE: this module imports ONLY rpg.* domain modules (engine, story.graph,
# story.model) + stdlib (sys). NO pymol, NO PyQt5. The rpg/ui/ dir is
...
# Pitfall 6). `python3.6 -c "import rpg.ui.controller"` MUST succeed in pure
...
only rpg.* domain modules + stdlib sys) so it is unit-testable in pure WSL
...
from rpg.engine import GameEngine, TurnResult  # noqa: F401 (TurnResult re-exported for the view)
from rpg.story.graph import StoryGraph
from rpg.story.model import EditIntent, MolAction  # noqa: F401 (MolAction used by HeroResolver)
