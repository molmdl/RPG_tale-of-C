# rpg/pymol_layer/asset_manager.py -- Phase 3 Plan 03-02 AssetManager.
#
...
class AssetManager(object):
    ...
    def _download_dir(self):
        ...
        Uses rpg.paths.data_path (``__file__``-relative -- cwd-independent,
    ...
    def load_bundled(self, filename, object_name):
        ...
        Resolves ``filename`` under rpg/data/assets/bundled/ (committed;
        ships in the plugin zip) via the ABSOLUTE rpg.paths.data_path --
        ...
        p = str(rpg.paths.data_path("data", "assets", "bundled", filename))
