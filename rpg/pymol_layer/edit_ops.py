# rpg/pymol_layer/edit_ops.py -- Phase 4 Plan 04-01 EditOps.
#
...
# cmd.alter may appear NOWHERE else in rpg/ or tools/.
#
...
tools/check_alter_gate.py allowlist = {rpg/pymol_layer/edit_ops.py}). The
