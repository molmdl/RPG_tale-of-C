# rpg/pymol_layer/protonation.py -- Phase 4 Plan 04-03 ProtonationManager.
#
...
# (rpg/protonation_catalog.py) and delegates the actual cmd.alter / cmd.h_add
...
#   * The catalog is the rpg.protonation_catalog MODULE (passed as a module
...
# tier (rpg/ root) stays pure-Python (no pymol import).
#
...
up a variant in the pure-data catalog (rpg.protonation_catalog) and routes
...
class ProtonationManager(object):
    ...
    def __init__(self, cmd, edit_ops, catalog, assets):
        ...
        self._catalog = catalog        # rpg.protonation_catalog module (pure data)
