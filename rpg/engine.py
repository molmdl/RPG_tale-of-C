...
from rpg.story.graph import StoryGraph  # noqa: F401 (type hint in docstrings)
...
from rpg.story.model import MolAction, EditIntent  # noqa: F401 (docstring refs)
from rpg.edit_router import EditRoutingError  # noqa: F401 (raised by route(); docstring ref)
...
class GameEngine(object):
    ...
    a player's :class:`~rpg.story.model.EditIntent` to a story node (known ->
    ...
    def apply_player_edit(self, edit_intent, enzyme_id):
        ...
        :class:`~rpg.edit_router.EditRoutingError` if the bad-ending pool is
        empty.
        """
