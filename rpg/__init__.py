...
"""rpg -- RPG: Tale of C PyMOL plugin package.
...
rpg/ui/plugin_entry.py (never import pymol/PyQt5 at module top level
...
def __init_plugin__(pmgapp):
    ...
    All pymol/PyQt5 imports are deferred to rpg/ui/plugin_entry.py
    ...
    #    Relative import resolves whether PyMOL imports us as 'startup.rpg'
    #    or 'pmg_tk.startup.rpg'. The name 'ui' is NOT in BANNED_TOP.
