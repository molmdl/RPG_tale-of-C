...
4. **ATP / True-Ending carbon-fate science conflict** (P4) — *the spec's "True = become ATP" conflicts with carbon-fate biochemistry (carbon exits as CO2 via PDH decarboxylation + TCA decarboxylations; ATP carbon comes from ribose/PPP, not respiration).* Conflates energy yield with carbon fate. Mitigation: **surface to human at the first content milestone** with 3 options: (a) redefine True as "energy fully harvested / released as CO2 after TCA" (accurate carbon fate), (b) re-route through PPP so carbon enters ribose → ATP (defensible but expands scope), (c) keep ATP framing but make dramatic layer explicitly about *energy* not *carbon*. **Do NOT silently pick.**
...
1. **ATP / True-Ending carbon-fate reframing** (Pitfall 4) — pick option (a), (b), or (c). Blocks True-Ending narrative. May expand scope (option b → PPP enzymes in cast) or change reachability.
...
1. **ATP / True-Ending carbon-fate reframing** — science decision the human must make before Phase 4 content. Three options on the table (Pitfall 4).
