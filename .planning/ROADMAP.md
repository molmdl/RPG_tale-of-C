...
- [ ] 05.4-04-PLAN.md — Human design-review checkpoint (SC4): checkpoint:human-verify reviewing 05.4-CONVENTION.md + both smoke outputs against the §8 review checklist + the 11 open questions; post-approval SUMMARY + STATE update; convention FROZEN for Phase 6/7/9/12 (Wave 3, after 05.4-02 + 05.4-03)
