...
- [ ] 05.1-12-PLAN.md — Bad-ending expansion Req 1 (1a: +6 unknown-pool bad endings [CG-collection variety]; 1b: +3 known-consequence bad endings [edit:known]; edit.prompt stub 3->12 structural choices) in bad_endings.json (Wave 1, expansion)
