...
- [ ] 05.3-02-PLAN.md — Headless prototype (tools/wt_align_smoke.py + 2 PDB fixtures [_wt_align_mut.pdb, _wt_align_wt.pdb]; cmd.super direct, NOT via molops; SMOKE_RESULT: PASS proving finite-RMSD + matched-atoms + mobile coords changed + substructure-scoped align) + human design-review checkpoint of the convention + the 8 open questions (SC2 + SC3) (Wave 2, after 05.3-01)
